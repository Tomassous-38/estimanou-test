        ...
        <div className="animate-fade-in-up animate-delay-100 md:w-7/12 text-center md:text-left">
          ...
          <div className="mb-8 pb-8 border-b border-navy/8">
            ...
            <div className="flex items-center justify-center md:justify-start gap-3">
              <Image src={city.testimonials[0].avatar} alt={city.testimonials[0].name} className="w-10 h-10 rounded-full object-cover" loading="lazy" width={40} height={40} />
              <div className="text-left">
          ...
          {city.testimonials[1] && (
            <div>
              ...
              <div className="flex items-center justify-center md:justify-start gap-3">
                <Image src={city.testimonials[1].avatar} alt={city.testimonials[1].name} className="w-10 h-10 rounded-full object-cover" loading="lazy" width={40} height={40} />
                <div className="text-left">
