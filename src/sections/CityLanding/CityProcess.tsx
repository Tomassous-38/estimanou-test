  ...
  const steps = [
    {
      ...
      description: `Remplissez le formulaire en ligne : type de bien, surface, localisation à ${city.name}.`,
    },
    {
      number: "02",
      icon: Search,
      title: "Analyse experte",
      description: `Valentin analyse les ventes récentes et les tendances du marché à ${city.name}.`,
    },
    {
      number: "03",
      icon: Mail,
      title: "Recevez l'estimation",
      description: "Vous recevez sous 48h une fourchette de prix argumentée et détaillée.",
    },
  ];
