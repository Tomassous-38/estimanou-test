    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-navy/60 via-navy/70 to-navy/80"></div>
      </div>
      ...
      <div className="relative flex flex-col items-center justify-center max-w-[900px] text-center mx-auto py-24 px-5 md:py-36 md:px-8">
        <span className="animate-fade-in-up pill-label !border-white/20 !text-white/60 mb-8">découvrir</span>
        ...
        <p className="animate-fade-in-up text-white/60 text-[15px] font-light mb-10 max-w-md leading-relaxed">
          En 2025 à La Réunion, 7 vendeurs sur 10 doivent revoir leur prix à la baisse après mise en vente. Ne faites pas partie de cette statistique.
        </p>

        <a
          href="/estimer"
          className="animate-fade-in-up group text-navy text-[13px] items-center bg-white inline-flex justify-center text-center px-10 py-4 md:px-12 md:py-5 rounded-full hover:bg-navy-100 transition-all duration-500 hover:shadow-xl uppercase tracking-[0.2em] font-normal"
        >
