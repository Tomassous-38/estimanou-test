          ...
          {articles.map((article, index) => (
            <Link href={`/blog/${article.slug}`} key={index} className="animate-fade-in-up group cursor-pointer text-left block">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-1.5 text-navy/80 text-[11px] font-normal tracking-wide pt-1 underline underline-offset-2 decoration-navy/25 group-hover:text-navy transition-colors duration-300">
                  lire l'article
                </div>
              </div>
            </Link>
